...
// tests -----------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	@Test def void testRecursiveReference() {
		...
		'''.parse => [
			assertError(DefinePackage.eINSTANCE.udtRef, DefineValidator.RECURSIVE_UDT_REFERENCE)
		]
	}
...
// methods -----------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	def void assertType(CharSequence input, DefineType expectedWrongType, DefineType expectedActualType) {
		(startWithVariable + input + endWithSemicolon).parse.assertError(DefinePackage.eINSTANCE.idiom,
