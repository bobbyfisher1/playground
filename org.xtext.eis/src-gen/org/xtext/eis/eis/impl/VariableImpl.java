 ...
 * </p>
 * <ul>
 * <li>{@link org.xtext.eis.eis.impl.VariableImpl#isVariantKeyword <em>Variant
 * Keyword</em>}</li>
 * <li>{@link org.xtext.eis.eis.impl.VariableImpl#getVariableType <em>Variable
 * Type</em>}</li>
 * <li>{@link org.xtext.eis.eis.impl.VariableImpl#getIdiom <em>Idiom</em>}</li>
 * <li>{@link org.xtext.eis.eis.impl.VariableImpl#getRange <em>Range</em>}</li>
 * <li>{@link org.xtext.eis.eis.impl.VariableImpl#isNextVariable <em>Next
 * Variable</em>}</li>
 * </ul>
 *
 * @generated
...
public class VariableImpl extends VariablesImpl implements Variable {
	/**
	 * The default value of the '{@link #isVariantKeyword() <em>Variant
	 * Keyword</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #isVariantKeyword() <em>Variant
	 * Keyword</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isVariantKeyword()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getVariableType() <em>Variable Type</em>}'
	...
	/**
	 * The cached value of the '{@link #getVariableType() <em>Variable Type</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getVariableType()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getIdiom() <em>Idiom</em>}' containment
	...
	/**
	 * The default value of the '{@link #isNextVariable() <em>Next Variable</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isNextVariable()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isNextVariable() <em>Next Variable</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isNextVariable()
	 * @generated
	...
	public void setVariantKeyword(boolean newVariantKeyword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EisPackage.VARIABLE__VARIANT_KEYWORD,
					oldVariantKeyword, variantKeyword));
	}
	...
	public void setVariableType(BasicType newVariableType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EisPackage.VARIABLE__VARIABLE_TYPE, oldVariableType,
					variableType));
	}
	...
	public NotificationChain basicSetIdiom(Idiom newIdiom, NotificationChain msgs) {
		...
		idiom = newIdiom;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EisPackage.VARIABLE__IDIOM,
					oldIdiom, newIdiom);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setIdiom(Idiom newIdiom) {
		if (newIdiom != idiom) {
			...
			if (idiom != null)
				msgs = ((InternalEObject) idiom).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EisPackage.VARIABLE__IDIOM, null, msgs);
			if (newIdiom != null)
				msgs = ((InternalEObject) newIdiom).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - EisPackage.VARIABLE__IDIOM, null, msgs);
	...
	public NotificationChain basicSetRange(Idiom newRange, NotificationChain msgs) {
		...
		range = newRange;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EisPackage.VARIABLE__RANGE,
					oldRange, newRange);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRange != range) {
			...
			if (range != null)
				msgs = ((InternalEObject) range).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EisPackage.VARIABLE__RANGE, null, msgs);
			if (newRange != null)
	...
	public void setNextVariable(boolean newNextVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EisPackage.VARIABLE__NEXT_VARIABLE, oldNextVariable,
					nextVariable));
	}
