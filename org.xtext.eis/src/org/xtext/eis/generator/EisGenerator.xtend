...
//
	...
	def private CharSequence compileIn(EList<Variables> variables, HashMap<Object, Object> setMap, String qualifiedName,
		String indent) {
		var charSeq = ""
	...
	def private CharSequence buildUdtRef(HashMap<Object, Object> setMap, String qualifiedName, String indent,
		UdtRef udtRef) {
		var charSeq = ""
		val tab = "	"
		...
		charSeq += indent
		charSeq +=
			'''<Element xsi: type="InputUDT" Name="«udtRef.name»" Datatype="«udtRef.udtType.name.toString»" Direction="«udtRef.directionBlock»">
			''' // newline		
		val indentPlus = indent + tab // indent++ 
		charSeq += indentPlus + '''<Elements>
		''' // newline
	...
	def private CharSequence compileOut(EList<Variables> variables, HashMap<Object, Object> idiomMap,
		HashMap<Object, Object> rangeMap, String qualifiedName, String indent) {
		var charSeq = ""
	...
	def private CharSequence buildUdt(Udt udt, HashMap<Object, Object> idiomMap, HashMap<Object, Object> rangeMap,
		String qualifiedName, String indent) {
		var charSeq = ""
		val tab = "	"
	...
	def private CharSequence buildUdtRef(UdtRef udtRef, HashMap<Object, Object> idiomMap,
		HashMap<Object, Object> rangeMap, String qualifiedName, String indent) {
		var charSeq = ""
		val tab = "	"
		...
		charSeq += indent
		charSeq +=
			'''<Element xsi: type="OutputUDT" Name="«udtRef.name»" Datatype="«udtRef.udtType.name.toString»" Direction="«udtRef.directionBlock»">
			''' // newline		
		val indentPlus = indent + tab // indent++ 
		charSeq += indentPlus + '''<Elements>
		''' // newline
...
//	
	...
	def private List<Variables> addInoutsInAssert(HashMap<Object, Object> assertIdiomMap,
		HashMap<Object, Object> assertRangeMap, TeststepBlock teststep) {
