...
public class EisGeneratorTest {
  ...
  public void testInOuts() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("output[\tinout int a = 1 +/- 2 ; ]");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("teststep(0, \"\"){");
  ...
  public void testErrorProneUseCase() {
    ...
    final Procedure1<String> _function = (String it) -> {
      try {
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"b\" Datatype=\"Int\" Direction=\"InOut\" Expect=\"0\" Range=\"\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t");
        _builder_1.append("</Elements>");
        _builder_1.newLine();
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"c\" Datatype=\"Int\" Direction=\"InOut\" Expect=\"0\" Range=\"\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t");
        _builder_1.append("</Outputs>");
        _builder_1.newLine();
  ...
  public void testInputsAndInOuts() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("inout udt a(typeA){");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("int b;");
    _builder.newLine();
  ...
  public void testDefaultValuesWithInouts() {
    ...
    final Procedure1<String> _function = (String it) -> {
      try {
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Input\" Name=\"c\" Datatype=\"Int\" Direction=\"InOut\" Value=\"2\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t");
        _builder_1.append("</Inputs>");
        _builder_1.newLine();
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"b\" Datatype=\"Int\" Direction=\"InOut\" Expect=\"46\" Range=\"\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t");
        _builder_1.append("</Elements>");
        _builder_1.newLine();
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"c\" Datatype=\"Int\" Direction=\"InOut\" Expect=\"2\" Range=\"\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t");
        _builder_1.append("</Outputs>");
        _builder_1.newLine();
  ...
  public void testOutputsAndInOuts() {
    ...
    final Procedure1<String> _function = (String it) -> {
      try {
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Input\" Name=\"b\" Datatype=\"Int\" Direction=\"InOut\" Value=\"0\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t");
        _builder_1.append("</Elements>");
        _builder_1.newLine();
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Input\" Name=\"c\" Datatype=\"Int\" Direction=\"InOut\" Value=\"0\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t");
        _builder_1.append("</Inputs>");
        _builder_1.newLine();
  ...
  public void testAll() {
    ...
    final Procedure1<String> _function = (String it) -> {
      try {
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Input\" Name=\"d\" Datatype=\"Int\" Direction=\"InOut\" Value=\"4\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Input\" Name=\"c\" Datatype=\"Bool\" Direction=\"InOut\" Value=\"false\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t");
        _builder_1.append("</Inputs>");
        _builder_1.newLine();
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"b\" Datatype=\"Int\" Direction=\"Output\" Expect=\"2\" Range=\"3\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"d\" Datatype=\"Int\" Direction=\"InOut\" Expect=\"4\" Range=\"5\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"c\" Datatype=\"Bool\" Direction=\"InOut\" Expect=\"false\" Range=\"\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t");
        _builder_1.append("</Outputs>");
        _builder_1.newLine();
  ...
  public void testLWord() {
    ...
    final Procedure1<String> _function = (String it) -> {
      try {
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Input\" Name=\"a\" Datatype=\"Lword\" Direction=\"Input\" Value=\"16#AAAA_AAAA_AAAA_AAAA\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t");
        _builder_1.append("</Inputs>");
        _builder_1.newLine();
