...
public class DefineSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Cascade(ISerializationContext context, Cascade semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DefinePackage.Literals.CASCADE__UDT_VAR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DefinePackage.Literals.CASCADE__UDT_VAR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCascadeAccess().getUdtVarVariablesIDTerminalRuleCall_1_0_1(), semanticObject.eGet(DefinePackage.Literals.CASCADE__UDT_VAR, false));
		feeder.finish();
	}
