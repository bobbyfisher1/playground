 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.define.define.AssertionBlock#getSet <em>Set</em>}</li>
 *   <li>{@link org.example.define.define.AssertionBlock#getAssert <em>Assert</em>}</li>
 * </ul>
 *
 * @see org.example.define.define.DefinePackage#getAssertionBlock()
 * @model
 * @generated
 */
public interface AssertionBlock extends EObject
{
   ...
   * @see #setSet(Set)
   * @see org.example.define.define.DefinePackage#getAssertionBlock_Set()
  ...
  /**
   * Sets the value of the '{@link org.example.define.define.AssertionBlock#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.example.define.define.DefinePackage#getAssertionBlock_Assert()
   * @model containment="true"
   * @generated
   */
  Assert getAssert();
  ...
  /**
   * Sets the value of the '{@link org.example.define.define.AssertionBlock#getAssert <em>Assert</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
