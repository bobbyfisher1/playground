 ...
 *   <li>{@link org.example.define.define.impl.VariableImpl#getIdiom <em>Idiom</em>}</li>
...
public class VariableImpl extends VariablesImpl implements Variable
{
  ...
  public NotificationChain basicSetIdiom(Idiom newIdiom, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DefinePackage.VARIABLE__IDIOM, oldIdiom, newIdiom);
  ...
  public void setIdiom(Idiom newIdiom)
  {
    if (newIdiom != idiom)
    {
      ...
      if (idiom != null)
        msgs = ((InternalEObject)idiom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DefinePackage.VARIABLE__IDIOM, null, msgs);
      if (newIdiom != null)
        msgs = ((InternalEObject)newIdiom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DefinePackage.VARIABLE__IDIOM, null, msgs);
      msgs = basicSetIdiom(newIdiom, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DefinePackage.VARIABLE__IDIOM, newIdiom, newIdiom));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DefinePackage.VARIABLE__IDIOM:
