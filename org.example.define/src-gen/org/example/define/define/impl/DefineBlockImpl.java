 ...
 *   <li>{@link org.example.define.define.impl.DefineBlockImpl#getTeststeps <em>Teststeps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefineBlockImpl extends MinimalEObjectImpl.Container implements DefineBlock
{
  ...
  public EList<TeststepBlock> getTeststeps()
  {
    if (teststeps == null)
    {
      teststeps = new EObjectContainmentEList<TeststepBlock>(TeststepBlock.class, this, DefinePackage.DEFINE_BLOCK__TESTSTEPS);
    }
    return teststeps;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case DefinePackage.DEFINE_BLOCK__TESTSTEPS:
