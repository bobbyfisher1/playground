...
public interface Set extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Set Variables</b></em>' attribute list.
   * The list contents are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Set Variables</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Set Variables</em>' attribute list.
   * @see org.example.define.define.DefinePackage#getSet_SetVariables()
   * @model unique="false"
   * @generated
   */
  EList<String> getSetVariables();
