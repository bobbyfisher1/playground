...
public class EisSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == EisPackage.eINSTANCE)
			...
			case EisPackage.BOOL_CONSTANT:
				if (rule == grammarAccess.getIdiomRule()
				...
				else if (rule == grammarAccess.getBoolConstantRule()) {
			...
			case EisPackage.PLUS:
				...
				return; 
			case EisPackage.SET:
				sequence_Set(context, (org.example.eis.eis.Set) semanticObject); 
				return; 
	...
	protected void sequence_FloatConstant(ISerializationContext context, EFloat semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, EisPackage.Literals.EFLOAT__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EisPackage.Literals.EFLOAT__VALUE));
			if (transientValues.isValueTransient(semanticObject, EisPackage.Literals.EFLOAT__VALUE_OF_DECIMAL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EisPackage.Literals.EFLOAT__VALUE_OF_DECIMAL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	 ...
	 */
	protected void sequence_Set(ISerializationContext context, org.example.eis.eis.Set semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
