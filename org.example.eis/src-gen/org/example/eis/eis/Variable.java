 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.eis.eis.Variable#isVariantKeyword <em>Variant Keyword</em>}</li>
 *   <li>{@link org.example.eis.eis.Variable#getVariableType <em>Variable Type</em>}</li>
 *   <li>{@link org.example.eis.eis.Variable#getIdiom <em>Idiom</em>}</li>
 *   <li>{@link org.example.eis.eis.Variable#getRange <em>Range</em>}</li>
 *   <li>{@link org.example.eis.eis.Variable#isNextVariable <em>Next Variable</em>}</li>
 * </ul>
 *
 * @see org.example.eis.eis.EisPackage#getVariable()
 * @model
 * @generated
 */
public interface Variable extends Variables
{
   ...
   * @see org.example.eis.eis.EisPackage#getVariable_VariantKeyword()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.example.eis.eis.Variable#isVariantKeyword <em>Variant Keyword</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The literals are from the enumeration {@link org.example.eis.eis.BasicType}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.example.eis.eis.EisPackage#getVariable_VariableType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.example.eis.eis.Variable#getVariableType <em>Variable Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setIdiom(Idiom)
   * @see org.example.eis.eis.EisPackage#getVariable_Idiom()
  ...
  /**
   * Sets the value of the '{@link org.example.eis.eis.Variable#getIdiom <em>Idiom</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setRange(Idiom)
   * @see org.example.eis.eis.EisPackage#getVariable_Range()
   * @model containment="true"
   * @generated
   */
  Idiom getRange();
  ...
  /**
   * Sets the value of the '{@link org.example.eis.eis.Variable#getRange <em>Range</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.example.eis.eis.EisPackage#getVariable_NextVariable()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.example.eis.eis.Variable#isNextVariable <em>Next Variable</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
