...
public class EisParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EisGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVariableAccess().getInoutAssignment_1(), "rule__Variable__InoutAssignment_1");
			builder.put(grammarAccess.getVariableAccess().getVariantKeywordAssignment_2(), "rule__Variable__VariantKeywordAssignment_2");
			builder.put(grammarAccess.getVariableAccess().getVariableTypeAssignment_3(), "rule__Variable__VariableTypeAssignment_3");
			builder.put(grammarAccess.getVariableAccess().getNameAssignment_4(), "rule__Variable__NameAssignment_4");
			builder.put(grammarAccess.getVariableAccess().getIdiomAssignment_5_1(), "rule__Variable__IdiomAssignment_5_1");
			...
			builder.put(grammarAccess.getUdtAccess().getInoutAssignment_0(), "rule__Udt__InoutAssignment_0");
			...
			builder.put(grammarAccess.getUdtRefAccess().getInoutAssignment_0(), "rule__UdtRef__InoutAssignment_0");
			builder.put(grammarAccess.getUdtRefAccess().getUdtTypeAssignment_1(), "rule__UdtRef__UdtTypeAssignment_1");
			builder.put(grammarAccess.getUdtRefAccess().getNameAssignment_2(), "rule__UdtRef__NameAssignment_2");
			builder.put(grammarAccess.getUdtRefAccess().getUdtVariablesAssignment_3(), "rule__UdtRef__UdtVariablesAssignment_3");
