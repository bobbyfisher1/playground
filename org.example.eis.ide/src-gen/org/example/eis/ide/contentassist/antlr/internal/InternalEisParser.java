...
public class InternalEisParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_LONG", "RULE_REAL", "RULE_BYTE", "RULE_WORD", "RULE_DWORD", "RULE_LWORD", "RULE_DIGIT", "RULE_HEXDIGIT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'FC'", "'FB'", "'true'", "'false'", "';'", "'=='", "'!='", "'>='", "'<='", "'>'", "'<'", "'*'", "'/'", "'null'", "'int'", "'bool'", "'real'", "'string'", "'byte'", "'word'", "'dword'", "'lword'", "'usint'", "'uint'", "'udint'", "'ulint'", "'sint'", "'dint'", "'lint'", "'char'", "'time'", "'s5time'", "'project'", "'='", "'plcname'", "'author'", "'testcase'", "'{'", "'}'", "'testActive'", "'blockType'", "'description'", "'define'", "'['", "']'", "'+/-'", "'udt'", "'('", "')'", "'||'", "'&&'", "'+'", "'-'", "'!'", "'teststep'", "','", "'.'", "'input'", "'output'", "'inout'", "'variant'", "'set'", "'assert'"
    };
    ...
    // InternalEis.g:6305:1: rule__Atomic__ValueAssignment_0_1 : ( RULE_LONG ) ;
    public final void rule__Atomic__ValueAssignment_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalEis.g:6309:1: ( ( RULE_LONG ) )
            // InternalEis.g:6310:2: ( RULE_LONG )
            {
            // InternalEis.g:6310:2: ( RULE_LONG )
            // InternalEis.g:6311:3: RULE_LONG
            {
    ...
    // InternalEis.g:6429:1: rule__TeststepBlock__PlcCycleAssignment_2 : ( RULE_LONG ) ;
    public final void rule__TeststepBlock__PlcCycleAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalEis.g:6433:1: ( ( RULE_LONG ) )
            // InternalEis.g:6434:2: ( RULE_LONG )
            {
            // InternalEis.g:6434:2: ( RULE_LONG )
            // InternalEis.g:6435:3: RULE_LONG
            {
