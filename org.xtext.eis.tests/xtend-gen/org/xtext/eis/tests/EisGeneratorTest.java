...
public class EisGeneratorTest {
  ...
  public void testAll() {
    ...
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant bool b = true;\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t//no range");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant real c = 3.4 +/- 1.1;");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant string d = \"hahaha\" ;\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t//no range");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant char e = \'9\' +/- \'7\';\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant byte f = 16#02 +/- 16#99;\t\t");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant word g = 16#1234 +/- 16#1234;");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant dword h = 16#9876_5432 +/- 16#9876_5432;");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant lword i = 16#abcd_efAB_CDEF_0123 +/- 16#abcd_efAB_CDEF_0123;");
    _builder.newLine();
    _builder.append("\t \t\t");
    ...
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant time q = T#40s +/- T#30M;\t\t");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant ltime r = LT#400d9ns +/- LT#2h486us;");
    _builder.newLine();
    _builder.append("\t \t\t");
    _builder.append("variant date s = D#2018-08-22;\t\t\t\t\t\t\t\t\t \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t//no range");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("/**/");
    _builder.newLine();
    ...
    final Procedure1<String> _function = (String it) -> {
      try {
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"e\" Datatype=\"Variant@Char\" Direction=\"InOut\" Expect=\"9\" Range=\"7\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"f\" Datatype=\"Variant@Byte\" Direction=\"InOut\" Expect=\"16#02\" Range=\"16#99\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"g\" Datatype=\"Variant@Word\" Direction=\"InOut\" Expect=\"16#1234\" Range=\"16#1234\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"h\" Datatype=\"Variant@DWord\" Direction=\"InOut\" Expect=\"16#9876_5432\" Range=\"16#9876_5432\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"i\" Datatype=\"Variant@LWord\" Direction=\"InOut\" Expect=\"16#ABCD_EFAB_CDEF_0123\" Range=\"16#ABCD_EFAB_CDEF_0123\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        ...
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"q\" Datatype=\"Variant@Time\" Direction=\"InOut\" Expect=\"T#40s\" Range=\"T#30m\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
        _builder_1.append("<Element xsi:type=\"Output\" Name=\"r\" Datatype=\"Variant@LTime\" Direction=\"InOut\" Expect=\"LT#400d9ns\" Range=\"LT#2h486us\" />");
        _builder_1.newLine();
        _builder_1.append("\t\t\t\t\t\t\t\t");
