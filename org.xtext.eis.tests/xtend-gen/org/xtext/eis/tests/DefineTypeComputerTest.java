...
public class DefineTypeComputerTest {
  ...
  public void testIsInt() {
    Assert.assertTrue(this._eisTypeComputer.isIntSuperType(EisTypeComputer.INT_TYPE));
  }
  
  @Test
  public void testAllTypes() {
    this.assertSameType("int a = 2;", EisTypeComputer.INT_TYPE);
    this.assertSameType("string b = \'stringaling\';", EisTypeComputer.STRING_TYPE);
    this.assertSameType("bool c = true;", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool d = true || false; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool e = true && false; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool f = true == false; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool g = true != false; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool h = 1>=0; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool i = 0<=1; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool j = 1>0; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool k = 0<1; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("bool p = !true; ", EisTypeComputer.BOOL_TYPE);
    this.assertSameType("int l = 1+1; ", EisTypeComputer.INT_TYPE);
    this.assertSameType("int m = 1-1; ", EisTypeComputer.INT_TYPE);
    this.assertSameType("int n = 1*1; ", EisTypeComputer.INT_TYPE);
    this.assertSameType("int o = 1/1; ", EisTypeComputer.INT_TYPE);
  }
  
  @Test
  public void testTypesWithPlusOp() {
    this.assertSameType("int a = 1+1;", EisTypeComputer.INT_TYPE);
    this.assertSameType("string b = 1+\'string\';", EisTypeComputer.STRING_TYPE);
    this.assertSameType("string c = \'string\'+1;", EisTypeComputer.STRING_TYPE);
    this.assertSameType("string d = \'string\'+\'string\';", EisTypeComputer.STRING_TYPE);
    this.assertSameType("string e = \'string\' + true;", EisTypeComputer.STRING_TYPE);
    this.assertSameType("string f = true + \'string\';", EisTypeComputer.STRING_TYPE);
  }
  
  @Test
  public void testIsString() {
    Assert.assertTrue(this._eisTypeComputer.isStringType(EisTypeComputer.STRING_TYPE));
  }
  
  @Test
  public void testIsBool() {
    Assert.assertTrue(this._eisTypeComputer.isBoolType(EisTypeComputer.BOOL_TYPE));
  }
  
  @Test
  public void testNotIsInt() {
    Assert.assertFalse(this._eisTypeComputer.isIntSuperType(EisTypeComputer.STRING_TYPE));
  }
  
  @Test
  public void testNotIsString() {
    Assert.assertFalse(this._eisTypeComputer.isStringType(EisTypeComputer.INT_TYPE));
  }
  
  @Test
  public void testNotIsBool() {
    Assert.assertFalse(this._eisTypeComputer.isBoolType(EisTypeComputer.INT_TYPE));
  }
  ...
  private void assertSameType(final String text, final EisType expectedType) {
    try {
      ...
      Assert.assertSame(this._eisTypeComputer.typeFor(((Variable) _get).getIdiom()), expectedType);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
