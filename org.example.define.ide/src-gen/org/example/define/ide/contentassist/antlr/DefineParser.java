		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVariableTypeAccess().getAlternatives_1(), "rule__VariableType__Alternatives_1");
					put(grammarAccess.getVariableTypeAccess().getBasicTypesAlternatives_1_0_0(), "rule__VariableType__BasicTypesAlternatives_1_0_0");
					...
					put(grammarAccess.getVariableAccess().getVariantKeywordAssignment_1_0(), "rule__Variable__VariantKeywordAssignment_1_0");
					put(grammarAccess.getVariableAccess().getVariantAssignment_1_1(), "rule__Variable__VariantAssignment_1_1");
					put(grammarAccess.getVariableAccess().getUdtAssignment_2(), "rule__Variable__UdtAssignment_2");
					...
					put(grammarAccess.getVariableTypeAccess().getBasicTypesAssignment_1_0(), "rule__VariableType__BasicTypesAssignment_1_0");
					put(grammarAccess.getVariableTypeAccess().getSpecifiedUdtTypeAssignment_1_1(), "rule__VariableType__SpecifiedUdtTypeAssignment_1_1");
